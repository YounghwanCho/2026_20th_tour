  ...
  <tr>
    ...
    <td width="50%" valign="top">
      <a href="https://www.google.com/maps/search/?api=1&query=Park+Hyatt+Vienna" target="_blank">
        <img src="./assets/vienna_map.png" width="100%" alt="구글 맵 위치 보기">
      </a>
    </td>
  </tr>
</table>
...
* **07:00 ~ 11:30**: 부다페스트에서 조식 후 체크아웃 및 기차역(Budapest-Keleti)으로 이동.
  * 🚇 **이동 방법 (파리시 우드버르 호텔 ➡️ 켈레티 기차역)**:
    ...
    * <a href="https://www.google.com/maps/dir/?api=1&origin=Párisi+Udvar+Hotel+Budapest&destination=Budapest-Keleti&travelmode=transit" target="_blank"><img src="./assets/bud_hotel_to_keleti_map_real.jpg" width="100%" style="border-radius:8px; margin-top:5px; margin-bottom:5px; max-width:500px;" alt="부다페스트 기차역 이동 경로 구글맵 캡처"></a>
...
* **14:20 ~ 15:00**: 비엔나 시내 진입 및 호텔 체크인. 파크 하얏트 비엔나는 구시가지 중심부(Am Hof)에 위치합니다.
  * 🚇 **이동 방법 (비엔나 중앙역 ➡️ 파크 하얏트 비엔나)**:
    ...
    * <a href="https://www.google.com/maps/dir/?api=1&origin=Wien+Hauptbahnhof&destination=Park+Hyatt+Vienna&travelmode=transit" target="_blank"><img src="./assets/vienna_hbf_to_hotel_map_real.jpg" width="100%" style="border-radius:8px; margin-top:5px; margin-bottom:5px; max-width:500px;" alt="비엔나 중앙역에서 호텔 이동 경로 구글맵 캡처"></a>
...
* **슈니첼 (Schnitzel)**: 송아지 고기나 돼지고기를 얇게 펴 튀긴 오스트리아식 돈가스. (레몬즙과 감자 샐러드 필수)
* **타펠슈피츠 (Tafelspitz)**: 소고기를 푹 삶아낸 오스트리아식 수육. 담백하고 부드러운 맛.
* **비엔나 커피 & 디저트**: 멜란지(Melange) 커피와 아펠슈트루델(사과 파이), 자허토르테(살구잼이 들어간 초코 케이크).
* **추천 식당 & 카페**:
  * **[피그뮬러 (Figlmüller)](https://www.google.com/maps/search/?api=1&query=Figlmüller+Vienna)**: 100년 전통의 얇고 거대한 슈니첼 맛집. (예약 필수)
...
* **마너(Manner) 웨하스**: 핑크색 포장지의 국민 과자. 선물용으로 가장 무난하고 인기 있음.
* **율리어스 마인들 (Julius Meinl)**: 비엔나의 프리미엄 커피 브랜드. 빨간 모자를 쓴 소년 로고 원두가 기념품으로 좋음.
* **모차르트 쿠겔 (Mozartkugel)**: 모차르트 얼굴이 그려진 초콜릿. (비엔나에서도 흔하게 살 수 있음)
* **알름두들러 (Almdudler)**: 오스트리아 국민 탄산음료. 허브향이 나는 달콤한 탄산음료로 식사 시 곁들이기 좋음.
